...
#================================row3=================================
        ...
        cpassowrd = Label(frame1, text="Confirm Password", font=("times new roman", 15, "bold"), bg="white", fg="gray").place(x=370, y=310)
        self.txt_cpassowrd=Entry(frame1,font=("time new roman",15),bg="lightgray")
        self.txt_cpassowrd.place(x=370,y=340,width=250)
        ...
        btn_login=Button(self.root, text="Sign In",command=self.Login_window,font=("time new roman",20),bd=0,cursor="hand2").place(x=200,y=460,width=180)

    def Login_window(self):
        self.root.destroy()
        import os
        os.startfile(r"D:\Project Python\images\Clock.py") 
    ...
    def clear(self):
        ...
        self.txt_cpassowrd.delete(0,END)
        self.cmb_quest.current(0)
        

    def register_data(self):
        if self.txt_fname.get()=="" or self.txt_contact.get()=="" or self.txt_email.get()=="" or self.cmb_quest.get()=="Select" or self.txt_answer.get()=="" or self.txt_password.get()=="" or self.txt_cpassowrd.get()=="": 
            messagebox.showerror("Error","All field Are Requried",parent=self.root)
        elif  self.txt_password.get()!=self.txt_cpassowrd.get():
