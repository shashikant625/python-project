...
class ReportClass:
    ...
    #=====search========
        ...
        btn_clear = Button(self.root, text="Clear", font=("goudy old style", 20, "bold"), bg="gray", fg="white", cursor="hand2",command=self.clear).place(x=800, y=100, width=100, height=35)
    ...
    #====Reslut label======
        ...
        lbl_full=Label(self.root,text="Totle Marks",font=("goudy old style",15,"bold"),bg="white",bd=2,relief=GROOVE).place(x=750,y=230,width=150,height=50)
    ...
    def delete(self):
        ...
        try:
            if self.var_id=="":
                ...
                row=cur.fetchone()
                if row==None:
                      messagebox.showerror("Error","Inva lid Student result",parent=self.root)
                else:
