...
class resultClass:
   ...
   #==========variable=========
        ...
        lbl_name=Label(self.root,text="Name Student",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=160)
        lbl_couse=Label(self.root,text="Course Student",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=220)
        lbl_marks_ob=Label(self.root,text="Marks Student",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=280)
        lbl_full_marks=Label(self.root,text="Full Marks Student",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=340)
        ...
        btn_search = Button(self.root, text="Search", font=("goudy old style", 20, "bold"), bg="#2196f3", fg="white", cursor="hand2",command=self.search).place(x=500, y=100, width=100, height=28)
  ...
  #b=========utton=====
        btn_add=Button(self.root,text="Subimt",font=("time new roman",15),bg="lightgreen",activebackground="lightgreen",cursor="hand2",command=self.add).place(x=300,y=420,width=120,height=35)

        btn_add=Button(self.root,text="Clear",font=("time new roman",15),bg="lightgray",activebackground="lightgray",cursor="hand2",command=self.clear).place(x=430,y=420,width=120,height=35)
     #======image=======
