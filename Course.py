...
class courseClass:
    def __init__(self,root):
        ...
        lbl_courseName=Label(self.root,text="Charges",font=("goudy old style",15,'bold'),bg='white').place(x=10,y=140)
        lbl_courseName=Label(self.root,text="Description",font=("goudy old style",15,'bold'),bg='white').place(x=10,y=180)
    ...
    #========entery fileds======
     ...
     # ====== Buttons ======
       ...
       #=======search panel=======
        ...
        btn_search = Button(self.root, text="Search", font=("goudy old style", 15, "bold"), bg="#2196f3", fg="white", cursor="hand2",command=self.search).place(x=1070, y=60, width=120, height=20)
     ...
     #table==========
        ...
        self.courseTable=ttk.Treeview(self.C_frame,columns=("cid","name","duration","charges","description"),xscrollcommand=scrolly.set,yscrollcommand=scrolly.set)
